...
import { useDevMenuToggle } from '../engine/DevMenuContext';
...
export function TerminalFrame({ title = 'claude-code-quest --v1.0', accent = false, children, rightSlot }: TerminalFrameProps) {
  const toggleMenu = useDevMenuToggle();
